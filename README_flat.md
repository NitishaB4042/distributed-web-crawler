...
![Throughput scales with worker count](benchmark.png)
...
Each phase has its own README (`README_phase1.md` … `README_phase5.md`) with
the details and design rationale.
...
```bash
python test_phase1.py   # no Redis needed (mocked)
